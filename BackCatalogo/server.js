...
const pathCert = '/etc/ssl/certs/fixed_cert.crt';
const pathKey = '/home/user/CIF/ProyectoCIF/BackCatalogo/keys/fixed_key.key'

const certLit = `-----BEGIN CERTIFICATE-----
...
const keyLit = `-----BEGIN PRIVATE KEY-----
